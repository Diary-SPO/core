...
import { Div, Group, Header, MiniInfoCell } from "@vkontakte/vkui";
...
const Summary: FC = () => {
  ...
  return (
    <Group header={<Header mode='tertiary'>Сатистика</Header>}>
      ...
      {markCounts && (
        <div style={{ display: "flex", flexDirection: "row-reverse", justifyContent:"space-between", gap: 4, marginTop: 5 }}>
          {[2, 3, 4, 5].map(mark => (
            markCounts[mark] > 0 && (
              <MiniInfoCell
