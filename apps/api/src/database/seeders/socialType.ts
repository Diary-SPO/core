  ...
  await seedSocialStepType([
    {
      ...
      description:
        'Нажмите на кнопку ниже, чтобы скопировать уникальный токен от Вашей учётной записи в дневнике. ' +
    ...
    },
    {
      ...
      description:
        'Нажмите на кнопку ниже. У Вас откроет telegram-бот. Просто отправьте ему скопированный выше токен.',
    ...
    },
    {
      ...
      title: 'Готово!',
      description:
        'Если бот ответил Вам со словами, что ваша учётная запись успешно привязана' +
