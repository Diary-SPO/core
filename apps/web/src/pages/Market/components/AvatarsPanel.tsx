...
import {
	...
	Icon16Gift, Icon20DownloadCloudOutline, Icon20DownloadOutline, Icon56StopwatchOutline,
	Icon56TagOutline
...
export const AvatarsPanel: FC<Props> = ({
	...
	const getMoreAvatars = () => {
		setShowsAvatars(getShowsAvatars + offset <= avatars.length
		...
		<Group header={
			...
			<Flex margin='auto' gap='2xl' justify='center'>
				{
					isForceLoading ?
						skeletons.map((_, index) => (
							<Skeleton key={index} width={110} height={110} borderRadius={100}/>
						))
						:
          ...
          <Flex justify='center' style={{marginTop: 35, marginBottom: 35}}>
              <Button appearance='accent'
											...
											disabled={isLoading}
											before={isLoading ? <Icon20DownloadOutline/> : <Icon20DownloadCloudOutline/>}>
